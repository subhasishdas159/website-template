    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			document.title = "Booking";
    			attr_dev(h1, "class", "is-size-2");
    			add_location(h1, file$7, 11, 4, 213);
    			attr_dev(a, "href", "#/home");
    			attr_dev(a, "class", "has-text-success has-text-weight-bold");
    			add_location(a, file$7, 12, 14, 278);
    			add_location(h3, file$7, 12, 4, 268);
    			attr_dev(div0, "class", "container");
    			add_location(div0, file$7, 10, 2, 185);
    			attr_dev(div1, "class", "section");
    			add_location(div1, file$7, 9, 0, 161);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = text(" for home");
    			document.title = "Booking";
    			add_location(h1, file$8, 6, 4, 107);
    			attr_dev(a, "href", "#/home");
    			attr_dev(a, "class", "has-text-success has-text-weight-bold");
    			add_location(a, file$8, 7, 14, 161);
    			add_location(h3, file$8, 7, 4, 151);
    			attr_dev(div0, "class", "container");
    			add_location(div0, file$8, 5, 2, 79);
    			attr_dev(div1, "class", "section");
    			add_location(div1, file$8, 4, 0, 55);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "class", "navbar-item svelte-1m5ik87");
    			attr_dev(a0, "href", "#/");
    			add_location(a0, file$9, 8, 6, 312);
    			attr_dev(span0, "aria-hidden", "true");
    			attr_dev(span0, "class", "svelte-1m5ik87");
    			add_location(span0, file$9, 12, 8, 635);
    			attr_dev(span1, "aria-hidden", "true");
    			attr_dev(span1, "class", "svelte-1m5ik87");
    			add_location(span1, file$9, 13, 8, 677);
    			attr_dev(span2, "aria-hidden", "true");
    			attr_dev(span2, "class", "svelte-1m5ik87");
    			add_location(span2, file$9, 14, 8, 719);
    			attr_dev(span3, "role", "button");
    			attr_dev(span3, "class", "navbar-burger svelte-1m5ik87");
    			...
    			attr_dev(div2, "class", "navbar-menu svelte-1m5ik87");
