...
var app = (function () {
    ...
    const file$6 = "src\\pages\\faq.svelte";
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			document.title = "Booking";
    			attr_dev(h1, "class", "is-size-2");
    			add_location(h1, file$6, 11, 4, 213);
    			attr_dev(a, "href", "#/home");
    			attr_dev(a, "class", "has-text-success has-text-weight-bold");
    			add_location(a, file$6, 12, 14, 278);
    			add_location(h3, file$6, 12, 4, 268);
    			attr_dev(div0, "class", "container");
    			add_location(div0, file$6, 10, 2, 185);
    			attr_dev(div1, "class", "section");
    			add_location(div1, file$6, 9, 0, 161);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "href", "#/home");
    			attr_dev(a, "class", "has-text-success has-text-weight-bold");
    			add_location(a, file$7, 7, 14, 161);
    			add_location(h3, file$7, 7, 4, 151);
    			attr_dev(div0, "class", "container");
