    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file, 5, 8, 215);
    			attr_dev(p0, "class", "is-size-5-desktop is-size-6-touch");
    			add_location(p0, file, 6, 8, 299);
    			add_location(br0, file, 6, 282, 573);
    			attr_dev(p1, "class", "is-size-5-desktop is-size-6-touch");
    			add_location(p1, file, 7, 8, 587);
    			add_location(br1, file, 7, 282, 861);
    			...
    			add_location(button0, file, 9, 10, 892);
    			...
    			add_location(button1, file, 10, 10, 1056);
    			...
    			add_location(button2, file, 11, 10, 1247);
    			add_location(div0, file, 8, 8, 875);
    			...
    			add_location(img, file, 15, 8, 1492);
    			attr_dev(div2, "class", "column is-hidden-touch");
    			add_location(div2, file, 14, 6, 1446);
